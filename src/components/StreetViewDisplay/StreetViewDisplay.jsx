...
const getCurrentFOV = (progressValue) => {
 ...
 const streetViewURL = `https://maps.googleapis.com/maps/api/streetview?size=600x484&location=${location.lat},${location.lng}&heading=0&pitch=0&fov=${currentFOV}&key=${API_KEY}`;
